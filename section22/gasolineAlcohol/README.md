<p align="center"> 
  <a href="https://gasolineoralcohol.netlify.app/" target="_blank">
  ...
  <img  src="https://raw.githubusercontent.com/jonasmzsouza/jonasmzsouza.github.io/main/assets/images/gasoline-alcohol.jpg"  width="100%"  alt="screenshot app dashboard">
</p>
<hr>
...
A hybrid application that compares which fuel to use by receiving fuel prices.
...
2. install the dependencies. (obs.: NodeJS v12)
```bash
cd gasolineAlcohol
npm install
```
